...
st.caption("Please select a study programm in England or Germany")



# selectbox - go into webpage DE or EN
# genre = st.radio(
#     "Please the country you are interested in studying in",
...
rent = st.slider('some text', 0, 800, 400, key="german_rent")
